  ...
  return (
    <div ref={avatarRef} className="group relative inline-block w-fit">
      ...
      {allowEdit && (
        ...
        >
          <div
            className={`absolute inset-0 bg-gray-800 opacity-0 group-hover:opacity-60 transition-opacity duration-200 w-[${width}px] h-[${height}px] rounded-full`}
          />
      ...
      {isAvatarClicked && (
        <div className="absolute flex flex-col min-w-max border-2 border-gray-200 shadow-sm bg-white rounded-lg mt-2">
          <p

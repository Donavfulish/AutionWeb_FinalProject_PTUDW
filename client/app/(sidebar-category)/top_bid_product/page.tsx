...
export default function Page() {
  ...
  let dataResult = null;
  const {
    data: topBiddingProductData,
    isLoading: isLoadingTopBiddingProduct,
    error: errorTopBiddingProduct,
  } = ProductHook.useGetTopBiddingProduct(per_page, Number(page));
  ...
  if (topBiddingProductData) {
    totalPages = Math.ceil(Number(totalBiddingProducts) / per_page);
    dataResult = topBiddingProducts as ProductPreview[];
  }
